...
public class BankOffice implements BankOfficeService {
    ...
    public BankOffice create(int officeId, String officeName, String officeAddress, boolean isOpen, boolean canAddAtm, boolean canTakeCredit, boolean canGiveMoney, boolean canDepositMoney, int rentingPrice, Bank bank) {
        this.officeId = officeId;
        this.officeName = officeName;
        this.officeAddress = officeAddress;
        this.isOpen = isOpen;
