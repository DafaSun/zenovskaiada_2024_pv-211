...
import tech.reliab.course.zenovskaiada.bank.service.AtmService;
...
public class BankAtm implements AtmService {
    ...
    public BankAtm create(int id, String name, String status, Bank chiefBank, BankOffice location, Employee employee, boolean canGiveMoney, boolean canDepositMoney, int servicePrice) {
        this.atmId = id;
        this.atmName = name;
        this.address = location.getOfficeAddress();
        this.status = status;
    ...
    public String toString() {
        String s1 = "\nBankAtm " +
                ...
                "\nОбслуживающий сотрудник: " + this.serviceEmployee.getName();
